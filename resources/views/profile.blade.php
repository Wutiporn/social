        ...
        <div class="row">
            ...
            @if(!empty($posts))
                @foreach($posts as $post)
                    <!-- posts คือ ตัวที่มีค่ามากกว่า 1 ค่า อาจจะเป็น array หรือตัวแปรชนิดอื่นๆ ที่มีการเก็บหลายๆค่าไว้
                        $post เฉยๆไม่มี s ทำหน้าที่วิ่งส่ง วิ่งใช้ที่ละ 1 ค่าจาก $posts วนไปเรื่อยๆตามจำนวนที่มีอยู่ใน $posts-->
                        <div class="card mt-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="ml-2">
                                            ...
                                            <div class="text-muted">
                                                <i class="fa fa-clock-0"></i> {{ $post -> created_at -> diffForHumans() }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
